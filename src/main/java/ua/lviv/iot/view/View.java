...
public class View {
    ...
    private Map<String, Printable> generateProblemMenuMethods() {
        ...
        Formatter<Problem, Integer> formatter = new Formatter<>(Problem.class);
        ViewOperations<Problem, Integer> problemOperation = new ViewOperations<>(problemController, formatter, Problem.class);
    ...
    private Map<String, Printable> generateResponsibleWorkerMenuMethods() {
        ...
        Formatter<ResponsibleWorker, Integer> formatter = new Formatter<>(ResponsibleWorker.class);
        ViewOperations<ResponsibleWorker, Integer> responsibleWorkerOperation = new ViewOperations<>(responsibleWorkerController, formatter, ResponsibleWorker.class);
    ...
    private Map<String, Printable> generateSolutionMenuMethods() {
        ...
        Formatter<Solution, String> formatter = new Formatter<>(Solution.class);
        ViewOperations<Solution, String> solutionOperation = new ViewOperations<>(solutionController, formatter, Solution.class);
    ...
    private Map<String, Printable> generateLocationMenuMethods() {
        ...
        Formatter<Location, Integer> formatter = new Formatter<>(Location.class);
        ViewOperations<Location, Integer> locationOperation = new ViewOperations<>(locationController, formatter, Location.class);
    ...
    private Map<String, Printable> generateApplicationMenuMethods() {
        ...
        Formatter<Application, Integer> formatter = new Formatter<>(Application.class);
        ViewOperations<Application, Integer> applicationOperation = new ViewOperations<>(applicationController, formatter, Application.class);
