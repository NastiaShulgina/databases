...
-- -----------------------------------------------------
-- Table `Hrabovenskyi`.`solution`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`solution`;
CREATE TABLE `Hrabovenskyi`.`solution` (
...
-- -----------------------------------------------------
-- Table `Hrabovenskyi`.`location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`location`;
CREATE TABLE `Hrabovenskyi`.`location` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_call_reporter`
    ...
    REFERENCES `Hrabovenskyi`.`solution` (`phone_number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE `Hrabovenskyi`.`call_has_rescue_vehicle` (
  ...
  CONSTRAINT `fk_call_has_rescue_vehicles_call1`
    FOREIGN KEY (`call_id`)
    REFERENCES `Hrabovenskyi`.`location` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `Hrabovenskyi`.`problem`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Hrabovenskyi`.`problem`;
CREATE TABLE `Hrabovenskyi`.`problem` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `Hrabovenskyi`.`injury` (
  ...
  CONSTRAINT `fk_injury_hospital1`
    ...
    REFERENCES `Hrabovenskyi`.`problem` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- solution
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380440609242', 'Nicholson', 'Jack');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380449209451', 'Marlon', 'Brando');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380635556157', 'De Nitro', 'Robert');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380395552787', 'Al', 'Pacino');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380395559610', 'Hoffman', 'Dustin');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380635554248', 'Hanks', 'Tom');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380505557912', 'Hopkins', 'Anthony');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380505556432', 'Newman', 'Paul');
INSERT INTO `hrabovenskyi`.`solution` (`phone_number`, `surname`, `name`) VALUES ('380417155524', 'Trasy', 'Spencer');

-- location
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `detailed_description`, `call_address_id`, `call_time`) VALUES ('380440609242', 'Boy broke his leg', 'Jumped down from the tree', '3', '2006-12-30 00:38:54.840');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `detailed_description`, `call_address_id`, `call_time`) VALUES ('380440609242', 'Boy broke his arm', 'During soccer', '5', '2006-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380449209451', 'Car stuck in the mud', '9', '2007-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380635556157', 'House on fire', '5', '2007-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380635554248', 'Car crash', '3', '2007-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380417155524', 'Robbery', '4', '2006-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380417155524', 'Flood', '2', '2008-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380505556432', 'Robbery', '6', '2008-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380505556432', 'Car crash', '7', '2008-12-31 00:38:54.840000');
INSERT INTO `hrabovenskyi`.`location` (`reporter_phone_number`, `short_description`, `call_address_id`, `call_time`) VALUES ('380417155524', 'Flood', '1', '2008-12-31 00:38:54.840000');
...
-- problem
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Children’s Hospitals');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('OKHMADYT Lviv Regional Children’s Clinical Hospital');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Lviv Regional Children’s Specialized Clinical Hospital');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Hospitals');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Municipal Clinical Hospital No. 10');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Municipal Communal Clinical Hospital No. 3');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Communal Clinical Hospital No. 4');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Communal Municipal Clinical Hospital No. 5');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Military Medical Service of the Office of Security Service of Ukraine in Lviv Region');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('State Border Guard Service Hospital');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Polyclinic of the Office of Ministry of Internal Affairs of Ukraine, Public Health Department in Lviv Region');
INSERT INTO `hrabovenskyi`.`problem` (`name`) VALUES ('Lviv Regional Medical Rehabilitation Hospital');
